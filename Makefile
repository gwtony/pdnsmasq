...
DBUSDIR       = dbus/
DESTDIR       = 
CFLAGS        = -Wall -W -O2 -g -DHAVE_DBUS -I/usr/include/dbus-1.0 -DLIBEXECDIR=\"$(LIBEXECDIR)\"
LDFLAGS       = -ldbus-1 -L/usr/lib/x86_64-linux-gnu/
COPTS         = 
RPM_OPT_FLAGS = 
LIBS          = 
...
clean :
	...
	rm -f $(DBUSDIR)/dnsmasq_radmin_helper $(DBUSDIR)/dnsmasq_purge

install : all install-common

install-common :
	$(INSTALL) -d $(DESTDIR)$(SBINDIR) -d $(DESTDIR)$(MANDIR)/man8 $(DESTDIR)$(LIBEXECDIR)
	$(INSTALL) -m 644 $(MAN)/dnsmasq.8 $(DESTDIR)$(MANDIR)/man8 
	$(INSTALL) -m 755 $(BUILDDIR)/dnsmasq $(DESTDIR)$(SBINDIR)
	$(INSTALL) -m 755 $(DBUSDIR)/dnsmasq_radmin_helper $(DESTDIR)$(LIBEXECDIR)
	$(INSTALL) -m 755 $(DBUSDIR)/dnsmasq_purge $(DESTDIR)$(BINDIR)
